...
void ADD_NEW(int* emp_count,int * arr_emp,struct Employee * emp);
void DIS_ONE(int* arr_emp,struct Employee emp[]);
void DIS_ALL(int * emp_count,struct Employee emp[],int * arr_empr);
void main(void)
{
