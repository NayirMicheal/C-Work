...
void TIM_voidInitialize(void)
{
	...
	SET_BIT(TCCR0,4);
	CLR_BIT(TCCR0,5);
#elif TIM_u8_MODE_CTC == TIM_u8_CTC_CLEAR
	CLR_BIT(TCCR0,4);
	SET_BIT(TCCR0,5);
	...
	SET_BIT(TCCR0,3);
	CLR_BIT(TCCR0,6);
#elif TIM_u8_MODE== TIM_u8_FAST_PWM
#if TIM_u8_FAST_PWM_MODES == TIM_u8_FAST_PWM_NORMAL
	CLR_BIT(TCCR0,4);
	CLR_BIT(TCCR0,5);
...
#elif TIM_u8_MODE== TIM_u8_PHASE_CORRECT
#if TIM_u8_PHASE_CORRECT_MODES == TIM_u8_PHASE_CORRECT_NORMAL
	CLR_BIT(TCCR0,4);
	CLR_BIT(TCCR0,5);
#elif TIM_u8_PHASE_CORRECT_MODES == TIM_u8_PHASE_CORRECT_REVERSE
	SET_BIT(TCCR0,4);
	CLR_BIT(TCCR0,5);
#elif TIM_u8_PHASE_CORRECT_MODES == TIM_u8_PHASE_CORRECT_CLEAR_OC0
	CLR_BIT(TCCR0,4);
	SET_BIT(TCCR0,5);
#elif TIM_u8_PHASE_CORRECT_MODES == TIM_u8_PHASE_CORRECT_SET_OC0
	SET_BIT(TCCR0,4);
	SET_BIT(TCCR0,5);
#endif
	OCR0=TIM_u8_OCR0_VALUE;
